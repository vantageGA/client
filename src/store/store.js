...
import {
  ...
  reviewerForgotPasswordReducer,
  reviewerUpdatePasswordReducer,
  createReviewReducer,
...
const reducer = combineReducers({
  ...
  profileOnboardingTutorialUpdate: profileOnboardingTutorialUpdateReducer,
  profileAIDraft: profileAIDraftReducer,
  ...
  reviewerForgotPassword: reviewerForgotPasswordReducer,
  reviewerUpdatePassword: reviewerUpdatePasswordReducer,
