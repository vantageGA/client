  ...
  return (
    <>
      <fieldset className="fieldSet">
        ...
        <p>
          At bodyvantage.co.uk, accessible from https://bodyvantage.co.uk, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by bodyvantage.co.uk and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in bodyvantage.co.uk. This policy is not
          applicable to any information collected offline or via channels other
          than this website. Our Privacy Policy was created with the help of the{' '}
          <a
            href="https://www.cookiepolicygenerator.com/privacy-
policy-generator/"
          >
        ...
        <h2>Log Files</h2>
        <p>
          bodyvantage.co.uk follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, bodyvantage.co.uk uses 'cookies'. These
        ...
        <p>
          ...
          advertising partners of bodyvantage.co.uk.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on bodyvantage.co.uk, which are
        ...
        <p>
          Note that bodyvantage.co.uk has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          bodyvantage.co.uk's Privacy Policy does not apply to other advertisers
        ...
        <p>
          bodyvantage.co.uk does not knowingly collect any Personal Identifiable
